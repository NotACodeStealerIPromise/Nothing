...
public abstract class CompatibleMeleeRenderer implements IItemRenderer {
   ...
   protected abstract CompatibleMeleeRenderer.StateDescriptor getStateDescriptor(EntityPlayer var1, ItemStack var2);
   ...
   public void renderItem(ItemRenderType type, ItemStack weaponItemStack, Object... data) {
      ...
      case 3:
         ...
         break;
      case 4:
         CompatibleMeleeRenderer.StateDescriptor stateDescriptor = this.getStateDescriptor((EntityPlayer)player, weaponItemStack);
   ...
   protected abstract BiConsumer getPartDebugPositioning();
   ...
   protected static class StateDescriptor {
      ...
      public StateDescriptor(PlayerMeleeInstance instance, MultipartRenderStateManager stateManager, float rate, float amplitude) {
