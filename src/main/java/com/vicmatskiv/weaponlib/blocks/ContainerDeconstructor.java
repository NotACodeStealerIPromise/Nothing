...
public class ContainerDeconstructor extends Container {
   ...
   public ContainerDeconstructor.State deconstructingState;
   public int x;
   public int y;
   public int z;

   public ContainerDeconstructor(InventoryPlayer parPlayerInventory, World parWorld, int parX, int parY, int parZ) {
      this.deconstructingState = ContainerDeconstructor.State.READY;
      this.x = 0;
      this.y = 0;
      this.z = 0;
      this.x = parX;
   ...
   public void onCraftMatrixChanged(IInventory parInventory) {
      if(parInventory == this.inputInventory) {
         ...
         if(amountRequired > this.inputInventory.getStackInSlot(0).stackSize) {
            ...
            this.deconstructingState = ContainerDeconstructor.State.ERROR;
            return;
         }
