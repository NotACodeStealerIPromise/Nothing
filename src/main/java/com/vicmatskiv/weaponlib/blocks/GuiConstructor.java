...
public class GuiConstructor extends GuiContainer {
   ...
   public GuiConstructor(InventoryPlayer playerInventory, World parWorld, String parBlockName, int parX, int parY, int parZ) {
      super(new ContainerConstructor(playerInventory, parWorld, parX, parY, parZ));
   ...
   protected void drawGuiContainerForegroundLayer(int par1, int par2) {
      ...
      if(string != null) {
         ContainerConstructor.State msgType = this.container.deconstructingState;
