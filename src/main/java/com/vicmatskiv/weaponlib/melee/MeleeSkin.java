...
public class MeleeSkin extends ItemAttachment {
   private List textureVariants;

   public MeleeSkin(String modId, AttachmentCategory category, ModelBase model, String textureName, String crosshair, ItemAttachment.ApplyHandler apply, ItemAttachment.ApplyHandler remove) {
   ...
   public static final class Builder extends AttachmentBuilder {
      ...
      public MeleeSkin.Builder withTextureVariant(String... textureVariantNames) {
      ...
      protected ItemAttachment createAttachment(ModContext modContext) {
         MeleeSkin skin = new MeleeSkin(this.getModId(), AttachmentCategory.SKIN, this.getModel(), this.getTextureName(), (String)null, (ItemAttachment.ApplyHandler)null, (ItemAttachment.ApplyHandler)null);
