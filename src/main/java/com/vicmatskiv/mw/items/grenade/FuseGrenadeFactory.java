...
public class FuseGrenadeFactory implements GrenadeFactory {
   public ItemGrenade createGrenade(CommonProxy commonProxy) {
      ...
      }).withCraftingRecipe(new Object[]{" XG", "XFX", " E ", Character.valueOf('X'), CommonProxy.SteelPlate, Character.valueOf('E'), CompatibleItems.FLINT_AND_STEEL, Character.valueOf('F'), CompatibleItems.GUNPOWDER, Character.valueOf('G'), "ingotSteel"}).withRenderer((new GrenadeRenderer.Builder()).withModId("mw").withModel(new M67Frag()).withAnimationDuration(500).withThrownEntityPositioning(() -> {
