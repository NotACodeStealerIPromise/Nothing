...
public class M93RFactory implements GunFactory {
   public Item createGun(CommonProxy commonProxy) {
      return (new Weapon.Builder()).withModId("mw").withName("M93R").withFireRate(0.6F).withRecoil(5.0F).withZoom(0.9F).withMaxShots(new int[]{3}).withShootSound("M93R").withSilencedShootSound("silencer").withReloadSound("PistolReload").withUnloadSound("Unload").withReloadingTime(50L).withCrosshair("gun").withCrosshairRunning("Running").withCrosshairZoomed("Sight").withFlashIntensity(1.0F).withFlashScale(() -> {
         ...
         return Arrays.asList(new String[]{"Type: Machine pistol", "Damage: 5", "Caliber: 9mm", "Magazines:", "15rnd 9mm Magazine", "Fire Rate: Semi"});
      ...
      }).withTextureNames(new String[]{"M9", "Electric"}).withRenderer((new WeaponRenderer.Builder()).withModId("mw").withModel(new M93R()).withEntityPositioning((itemStack) -> {
