...
import com.vicmatskiv.mw.models.MP5SD;
...
public class MP5SDFactory implements GunFactory {
   public Item createGun(CommonProxy commonProxy) {
      return (new Weapon.Builder()).withModId("mw").withName("HKMP5SD").withFireRate(0.8F).withRecoil(2.3F).withZoom(0.9F).withMaxShots(new int[]{Integer.MAX_VALUE, 1}).withShootSound("MP5Silenced").withReloadSound("StandardReload").withUnloadSound("Unload").withReloadingTime(43L).withCrosshair("gun").withCrosshairRunning("Running").withCrosshairZoomed("Sight").withFlashIntensity(0.6F).withFlashScale(() -> {
         return Float.valueOf(0.8F);
      }).withFlashOffsetX(() -> {
         return Float.valueOf(0.1F);
      }).withFlashOffsetY(() -> {
         return Float.valueOf(0.1F);
      }).withInaccuracy(2.0F).withCreativeTab(ModernWarfareMod.SMGTab).withCrafting(CraftingComplexity.LOW, new Object[]{CommonProxy.SteelPlate, CommonProxy.MetalComponents, CommonProxy.BigSteelPlate, "ingotSteel", Attachments.Silencer9mm}).withInformationProvider((stack) -> {
         return Arrays.asList(new String[]{"--Automatically Silenced--", "", "Type: Submachine gun", "Damage: 6.5", "Caliber: 9mm", "Magazines:", "25rnd 9mm Magazine", "Fire Rate: Auto"});
      ...
      }).withTextureNames(new String[]{"MP5A5", "Electric"}).withRenderer((new WeaponRenderer.Builder()).withModId("mw").withModel(new MP5SD()).withEntityPositioning((itemStack) -> {
         ...
         GL11.glScaled(0.6000000238418579D, 0.6000000238418579D, 0.6000000238418579D);
         GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
      }, 150L, 50L)}).withFirstPersonCustomPositioningUnloading(Magazines.MP5KMag, new Transition[]{new Transition((renderContext) -> {
      ...
      }, 250L, 1000L)}).withFirstPersonCustomPositioningReloading(Magazines.MP5KMag, new Transition[]{new Transition((renderContext) -> {
      ...
      }, 250L, 1000L)}).withFirstPersonCustomPositioningReloading(AuxiliaryAttachments.M9SDsuppressor.getRenderablePart(), new Transition[]{new Transition((renderContext) -> {
      }, 250L, 1000L), new Transition((renderContext) -> {
      }, 250L, 1000L), new Transition((renderContext) -> {
      }, 250L, 1000L), new Transition((renderContext) -> {
      }, 250L, 1000L), new Transition((renderContext) -> {
      }, 250L, 1000L), new Transition((renderContext) -> {
      }, 250L, 1000L)}).withFirstPersonCustomPositioningUnloading(AuxiliaryAttachments.M9SDsuppressor.getRenderablePart(), new Transition[]{new Transition((renderContext) -> {
      }, 250L, 1000L), new Transition((renderContext) -> {
