...
public class XEagleFactory implements GunFactory {
   public Item createGun(CommonProxy commonProxy) {
      return (new Weapon.Builder()).withModId("mw").withName(".357 Desert Eagle").withFireRate(0.2F).withRecoil(6.0F).withZoom(0.9F).withMaxShots(new int[]{1}).withShootSound("Deagle").withSilencedShootSound("silencer").withReloadSound("PistolReload").withUnloadSound("Unload").withReloadingTime(50L).withCrosshair("gun").withCrosshairRunning("Running").withCrosshairZoomed("Sight").withInaccuracy(4.0F).withFlashIntensity(1.0F).withFlashScale(() -> {
         ...
         return Arrays.asList(new String[]{"Type: Pistol", "Damage: 11", "Caliber: .357", "Magazines:", "9rnd .357 Magazine", "Fire Rate: Semi"});
      ...
      })).withCompatibleAttachment(AuxiliaryAttachments.DeagleTop, true, (model) -> {
      }).withCompatibleAttachment(Magazines.DeagleMag, (Consumer)((model) -> {
         ...
         GL11.glScaled(1.5D, 1.5D, 1.7000000476837158D);
      }).withTextureNames(new String[]{"Deagle", "DeagleGold", "Electric"}).withRenderer((new WeaponRenderer.Builder()).withModId("mw").withModel(new Deagle()).withEntityPositioning((itemStack) -> {
      ...
      }).withFirstPersonPositioningCustomRecoiled(AuxiliaryAttachments.DeagleTop.getRenderablePart(), (renderContext) -> {
         GL11.glTranslatef(0.0F, 0.0F, 0.5F);
      }).withFirstPersonPositioningCustomZoomingRecoiled(AuxiliaryAttachments.DeagleTop.getRenderablePart(), (renderContext) -> {
         GL11.glTranslatef(0.0F, 0.0F, 0.5F);
      }).withFirstPersonPositioningCustomRecoiled(Magazines.DeagleMag, (renderContext) -> {
      }).withFirstPersonPositioningCustomZoomingRecoiled(Magazines.DeagleMag, (renderContext) -> {
      ...
      }).withFirstPersonCustomPositioning(Magazines.DeagleMag, (renderContext) -> {
      }).withFirstPersonCustomPositioning(AuxiliaryAttachments.DeagleTop.getRenderablePart(), (renderContext) -> {
         ...
         GL11.glRotatef(-10.0F, 0.0F, 0.0F, 1.0F);
         GL11.glTranslatef(1.0F, -1.2F, 0.0F);
      }, 150L, 50L)}).withFirstPersonCustomPositioningUnloading(Magazines.DeagleMag, new Transition[]{new Transition((renderContext) -> {
      }, 250L, 1000L), new Transition((renderContext) -> {
         GL11.glTranslatef(0.05F, 1.3F, 0.4F);
      }, 250L, 1000L)}).withFirstPersonCustomPositioningReloading(Magazines.DeagleMag, new Transition[]{new Transition((renderContext) -> {
         GL11.glTranslatef(0.05F, 1.3F, 0.4F);
      }, 250L, 1000L), new Transition((renderContext) -> {
      }, 250L, 1000L), new Transition((renderContext) -> {
      }, 250L, 1000L)}).withFirstPersonCustomPositioningUnloading(AuxiliaryAttachments.DeagleTop.getRenderablePart(), new Transition[]{new Transition((renderContext) -> {
         GL11.glTranslatef(0.0F, 0.0F, 0.5F);
      }, 250L, 1000L), new Transition((renderContext) -> {
         GL11.glTranslatef(0.0F, 0.0F, 0.5F);
      }, 250L, 1000L)}).withFirstPersonCustomPositioningReloading(AuxiliaryAttachments.DeagleTop.getRenderablePart(), new Transition[]{new Transition((renderContext) -> {
         GL11.glTranslatef(0.0F, 0.0F, 0.5F);
      }, 250L, 1000L), new Transition((renderContext) -> {
         GL11.glTranslatef(0.0F, 0.0F, 0.5F);
      }, 250L, 1000L), new Transition((renderContext) -> {
