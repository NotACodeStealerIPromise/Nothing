...
public class SPAS15Factory implements GunFactory {
   public Item createGun(CommonProxy commonProxy) {
      return (new Weapon.Builder()).withModId("mw").withName("SPAS-15").withAmmoCapacity(8).withFireRate(0.3F).withRecoil(9.0F).withZoom(0.9F).withMaxShots(new int[]{1}).withShootSound("SPAS15").withReloadSound("NoBoltReload").withReloadingTime(30L).withCrosshair("gun").withCrosshairRunning("Running").withCrosshairZoomed("Sight").withInaccuracy(10.0F).withPellets(10).withFlashIntensity(1.0F).withCreativeTab(ModernWarfareMod.gunsTab).withTextureNames(new String[]{"AK12", "Red", "Black", "Desert", "Green", "Blue", "Orange", "Purple", "Cyan", "White", "Arctic", "Electric", "Redline", "M4Cyrex", "Fade", "IceAndFire", "Fade2", "GreenElectric", "Handgun", "Creativity", "Dragon", "ASMO", "Vulcan", "GreenVulcan", "Guardian"}).withRenderer((new WeaponRenderer.Builder()).withModId("mw").withModel(new SPAS15()).withEntityPositioning((itemStack) -> {
