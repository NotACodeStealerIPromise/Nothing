...
public class M110Factory implements GunFactory {
   public Item createGun(CommonProxy commonProxy) {
      return (new Weapon.Builder()).withModId("mw").withName("M110").withFireRate(0.2F).withRecoil(3.5F).withZoom(0.9F).withMaxShots(new int[]{1, Integer.MAX_VALUE}).withShootSound("M110").withSilencedShootSound("RifleSilencer").withReloadSound("StandardReload").withUnloadSound("Unload").withReloadingTime(50L).withCrosshair("gun").withCrosshairRunning("Running").withCrosshairZoomed("Sight").withFlashIntensity(1.0F).withFlashScale(() -> {
         ...
         return Arrays.asList(new String[]{"Type: Sniper rifle/Designated marksmen rifle", "Damage: 15", "Caliber: 7.62x51mm NATO", "Magazines:", "10rnd 7.62x51mm NATO Magazine (Type 2)", "Fire Rate: Semi"});
      ...
      }).withTextureNames(new String[]{"M110", "Electric"}).withRenderer((new WeaponRenderer.Builder()).withModId("mw").withModel(new M110()).withEntityPositioning((itemStack) -> {
         GL11.glScaled(0.5D, 0.5D, 0.5D);
