...
public class QBS09Factory implements GunFactory {
   public Item createGun(CommonProxy commonProxy) {
      return (new Weapon.Builder()).withModId("mw").withName("QBS09").withAmmoCapacity(7).withMaxBulletsPerReload(7).withFireRate(0.2F).withRecoil(9.0F).withZoom(0.9F).withMaxShots(new int[]{1}).withShootSound("QBS09").withSilencedShootSound("ShotgunSilenced").withReloadSound("ShotgunReload").withReloadingTime(15L).withCrosshair("gun").withCrosshairRunning("Running").withCrosshairZoomed("Sight").withInaccuracy(10.0F).withPellets(10).withFlashIntensity(1.0F).withFlashScale(() -> {
      ...
      }).withTextureNames(new String[]{"QBS09", "Electric"}).withCompatibleAttachment(AuxiliaryAttachments.Extra, true, (model) -> {
