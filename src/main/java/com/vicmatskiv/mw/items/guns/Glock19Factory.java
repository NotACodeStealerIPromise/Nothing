...
public class Glock19Factory implements GunFactory {
   public Item createGun(CommonProxy commonProxy) {
      return (new Weapon.Builder()).withModId("mw").withName("Glock19").withFireRate(0.5F).withRecoil(5.5F).withZoom(0.9F).withMaxShots(new int[]{5, 1, Integer.MAX_VALUE}).withShootSound("G18").withSilencedShootSound("silencer").withReloadSound("PistolReload").withUnloadSound("Unload").withReloadingTime(50L).withCrosshair("gun").withCrosshairRunning("Running").withCrosshairZoomed("Sight").withFlashIntensity(1.0F).withFlashScale(() -> {
