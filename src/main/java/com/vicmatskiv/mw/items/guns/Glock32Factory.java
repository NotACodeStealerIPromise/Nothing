...
import com.vicmatskiv.mw.models.Glock32;
...
public class Glock32Factory implements GunFactory {
   public Item createGun(CommonProxy commonProxy) {
      return (new Weapon.Builder()).withModId("mw").withName("Glock32").withFireRate(0.8F).withRecoil(5.5F).withZoom(0.9F).withMaxShots(new int[]{1}).withShootSound("Glock32").withSilencedShootSound("Glock32Silenced").withReloadSound("PistolReload").withUnloadSound("Unload").withReloadingTime(50L).withCrosshair("gun").withCrosshairRunning("Running").withCrosshairZoomed("Sight").withFlashIntensity(1.0F).withFlashScale(() -> {
         ...
         return Arrays.asList(new String[]{"Type: Pistol", "Damage: 6", "Caliber: .357", "Magazines:", "14rnd .357 Magazine", "Fire Rate: Semi"});
      ...
      }).withCompatibleAttachment(Magazines.Glock32Mag, (Consumer)((model) -> {
      ...
      }).withTextureNames(new String[]{"G21", "Electric"}).withRenderer((new WeaponRenderer.Builder()).withModId("mw").withModel(new Glock32()).withEntityPositioning((itemStack) -> {
         ...
         GL11.glRotatef(-10.0F, 0.0F, 0.0F, 1.0F);
         GL11.glTranslatef(1.0F, -1.2F, 0.0F);
      }, 150L, 50L)}).withFirstPersonCustomPositioningUnloading(Magazines.Glock32Mag, new Transition[]{new Transition((renderContext) -> {
      }, 250L, 1000L), new Transition((renderContext) -> {
         GL11.glTranslatef(0.05F, 1.3F, 0.4F);
      }, 250L, 1000L)}).withFirstPersonCustomPositioningReloading(Magazines.Glock32Mag, new Transition[]{new Transition((renderContext) -> {
         GL11.glTranslatef(0.05F, 1.3F, 0.4F);
      }, 250L, 1000L), new Transition((renderContext) -> {
      }, 250L, 1000L), new Transition((renderContext) -> {
