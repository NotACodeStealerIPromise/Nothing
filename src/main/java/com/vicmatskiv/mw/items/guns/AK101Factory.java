...
public class AK101Factory implements GunFactory {
   public Item createGun(CommonProxy commonProxy) {
      return (new Weapon.Builder()).withModId("mw").withName("AK101").withFireRate(0.6F).withRecoil(2.5F).withZoom(0.9F).withMaxShots(new int[]{Integer.MAX_VALUE, 1}).withShootSound("AK74M").withSilencedShootSound("AKsilenced").withReloadSound("AKReload").withUnloadSound("akunload").withReloadingTime(45L).withCrosshair("gun").withCrosshairRunning("Running").withCrosshairZoomed("Sight").withFlashIntensity(1.0F).withFlashScale(() -> {
         return Float.valueOf(0.8F);
      }).withFlashOffsetX(() -> {
         return Float.valueOf(0.1F);
      }).withFlashOffsetY(() -> {
         return Float.valueOf(0.1F);
      }).withInaccuracy(1.0F).withCreativeTab(ModernWarfareMod.AssaultRiflesTab).withCrafting(CraftingComplexity.MEDIUM, new Object[]{CommonProxy.SteelPlate, CommonProxy.MiniSteelPlate, CommonProxy.MetalComponents}).withInformationProvider((stack) -> {
         return Arrays.asList(new String[]{"Type: Assault rifle", "Damage: 7", "Caliber: 5.56x45mm NATO", "Magazines:", "32rnd 5.56x45mm NATO Magazine", "Fire Rate: Auto"});
      ...
      }).withCompatibleAttachment(Magazines.AK101Mag, (Consumer)((model) -> {
      ...
      })).withTextureNames(new String[]{"AK74M"}).withRenderer((new WeaponRenderer.Builder()).withModId("mw").withModel(new AK74M()).withEntityPositioning((itemStack) -> {
      ...
      }).withFirstPersonCustomPositioning(Magazines.AK101Mag, (renderContext) -> {
         ...
         GL11.glTranslatef(0.0F, 0.0F, 1.0F);
      }).withFirstPersonPositioningCustomRecoiled(Magazines.AK101Mag.getRenderablePart(), (renderContext) -> {
      }).withFirstPersonPositioningCustomZoomingRecoiled(Magazines.AK101Mag.getRenderablePart(), (renderContext) -> {
      ...
      }, 250L, 1000L)}).withFirstPersonCustomPositioningUnloading(Magazines.AK101Mag, new Transition[]{new Transition((renderContext) -> {
      }, 250L, 1000L), new Transition((renderContext) -> {
         GL11.glTranslatef(0.0F, 1.3F, 0.5F);
         GL11.glRotatef(20.0F, 1.0F, 0.0F, 0.0F);
      }, 250L, 1000L)}).withFirstPersonCustomPositioningReloading(Magazines.AK101Mag, new Transition[]{new Transition((renderContext) -> {
         GL11.glTranslatef(0.0F, 1.3F, 0.5F);
         GL11.glRotatef(20.0F, 1.0F, 0.0F, 0.0F);
