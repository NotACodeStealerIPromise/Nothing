...
public class UMP9Factory implements GunFactory {
   public Item createGun(CommonProxy commonProxy) {
      return (new Weapon.Builder()).withModId("mw").withName("HKUMP9").withFireRate(0.6F).withRecoil(2.3F).withZoom(0.9F).withMaxShots(new int[]{Integer.MAX_VALUE, 1}).withShootSound("UMP45").withSilencedShootSound("MP5Silenced").withReloadSound("StandardReload").withUnloadSound("Unload").withReloadingTime(43L).withCrosshair("gun").withCrosshairRunning("Running").withCrosshairZoomed("Sight").withFlashIntensity(1.0F).withFlashScale(() -> {
         ...
         return Arrays.asList(new String[]{"Type: Submachine gun", "Damage: 6.4", "Caliber: 9mm", "Magazines:", "25rnd 9mm Magazine", "Fire Rate: Auto"});
         ...
         GL11.glScaled(0.800000011920929D, 0.800000011920929D, 0.8999999761581421D);
