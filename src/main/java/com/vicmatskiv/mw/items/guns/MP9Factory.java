...
public class MP9Factory implements GunFactory {
   public Item createGun(CommonProxy commonProxy) {
      ...
      }).withCreativeTab(ModernWarfareMod.SMGTab).withCrafting(CraftingComplexity.MEDIUM, new Object[]{CommonProxy.SteelPlate, CommonProxy.MiniSteelPlate}).withInformationProvider((stack) -> {
         return Arrays.asList(new String[]{"Type: Submachine gun", "Damage: 5", "Caliber: 9mm", "Magazines:", "20rnd 9mm Magazine", "Fire Rate: Auto"});
      ...
      }).withTextureNames(new String[]{"AK12"}).withRenderer((new WeaponRenderer.Builder()).withModId("mw").withModel(new MP9()).withEntityPositioning((itemStack) -> {
