...
public class AKMFactory implements GunFactory {
   public Item createGun(CommonProxy commonProxy) {
      ...
      })).withTextureNames(new String[]{"AKM"}).withRenderer((new WeaponRenderer.Builder()).withModId("mw").withModel(new AKM()).withEntityPositioning((itemStack) -> {
