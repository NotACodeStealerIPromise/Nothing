...
public class G3Factory implements GunFactory {
   public Item createGun(CommonProxy commonProxy) {
      return (new Weapon.Builder()).withModId("mw").withName("G3").withFireRate(0.4F).withRecoil(2.3F).withZoom(0.95F).withMaxShots(new int[]{1, 3, Integer.MAX_VALUE}).withShootSound("G3").withSilencedShootSound("G3Silenced").withReloadSound("StandardReload").withUnloadSound("Unload").withReloadingTime(43L).withCrosshair("gun").withCrosshairRunning("Running").withCrosshairZoomed("Sight").withFlashIntensity(1.0F).withFlashScale(() -> {
         ...
         return Arrays.asList(new String[]{"Type: Battle rifle", "Damage: 15", "Caliber: 7.62x51mm", "Magazines:", "21rnd 7.62x51mm Magazine", "Fire Rate: Semi"});
      ...
      })).withCompatibleAttachment(Magazines.G3Mag, (Consumer)((model) -> {
      ...
      }).withTextureNames(new String[]{"G3", "Electric"}).withRenderer((new WeaponRenderer.Builder()).withModId("mw").withModel(new G3()).withEntityPositioning((itemStack) -> {
         ...
         GL11.glScaled(0.6000000238418579D, 0.6000000238418579D, 0.6000000238418579D);
         GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
      }, 150L, 50L)}).withFirstPersonCustomPositioningUnloading(Magazines.G3Mag, new Transition[]{new Transition((renderContext) -> {
      ...
      }, 250L, 1000L)}).withFirstPersonCustomPositioningReloading(Magazines.G3Mag, new Transition[]{new Transition((renderContext) -> {
