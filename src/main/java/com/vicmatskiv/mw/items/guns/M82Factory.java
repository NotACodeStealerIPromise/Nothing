...
public class M82Factory implements GunFactory {
   public Item createGun(CommonProxy commonProxy) {
      return (new Weapon.Builder()).withModId("mw").withName("M82").withFireRate(0.16F).withRecoil(4.0F).withZoom(0.9F).withMaxShots(new int[]{1}).withShootSound("M107").withSilencedShootSound("RifleSilencer").withReloadSound("AKReload").withUnloadSound("Unload").withReloadingTime(43L).withCrosshair("gun").withCrosshairRunning("Running").withCrosshairZoomed("Sight").withFlashIntensity(1.0F).withFlashScale(() -> {
         ...
         return Arrays.asList(new String[]{"Type: Anti-materiel sniper rifle", "Damage: 36.4", "Caliber: .50 BMG", "Magazines:", "10rnd .50 BMG Magazine (Type 2)", "Fire Rate: Semi"});
      ...
      }).withTextureNames(new String[]{"M82", "M107Blue", "M107Red", "Electric"}).withRenderer((new WeaponRenderer.Builder()).withModId("mw").withModel(new M107()).withEntityPositioning((itemStack) -> {
