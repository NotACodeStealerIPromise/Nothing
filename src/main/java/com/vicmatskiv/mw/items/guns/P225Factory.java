...
import com.vicmatskiv.mw.models.P225;
...
public class P225Factory implements GunFactory {
   public Item createGun(CommonProxy commonProxy) {
      ...
      }).withTextureNames(new String[]{"P225", "Electric"}).withRenderer((new WeaponRenderer.Builder()).withModId("mw").withModel(new P225()).withEntityPositioning((itemStack) -> {
