...
public class M240Factory implements GunFactory {
   public Item createGun(CommonProxy commonProxy) {
      return (new Weapon.Builder()).withModId("mw").withName("M240").withFireRate(0.6F).withRecoil(2.5F).withZoom(0.9F).withShootSound("M240").withSilencedShootSound("RifleSilencer").withReloadSound("M249Reload").withUnloadSound("Unload").withReloadingTime(110L).withCrosshair("gun").withCrosshairRunning("Running").withCrosshairZoomed("Sight").withFlashIntensity(1.0F).withFlashScale(() -> {
         ...
         return Arrays.asList(new String[]{"Type: General-purpose machine gun", "Damage: 8.5", "Caliber: 7.62x51mm NATO", "Magazines:", "200rnd 7.62x51mm NATO Magazine", "Fire Rate: Auto"});
      ...
      })).withCompatibleAttachment(Magazines.M240Mag, (Consumer)((model) -> {
      ...
      }).withTextureNames(new String[]{"GunmetalTexture", "Electric"}).withRenderer((new WeaponRenderer.Builder()).withModId("mw").withModel(new M240()).withEntityPositioning((itemStack) -> {
         GL11.glScaled(0.5D, 0.5D, 0.5D);
      ...
      }).withFirstPersonCustomPositioning(Magazines.M240Mag, (renderContext) -> {
         ...
         GL11.glScaled(0.550000011920929D, 0.550000011920929D, 0.550000011920929D);
         GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
      }, 150L, 50L)}).withFirstPersonCustomPositioningUnloading(Magazines.M240Mag, new Transition[]{new Transition((renderContext) -> {
      ...
      }, 250L, 1000L)}).withFirstPersonCustomPositioningReloading(Magazines.M240Mag, new Transition[]{new Transition((renderContext) -> {
