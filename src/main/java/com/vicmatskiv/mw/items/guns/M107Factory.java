...
public class M107Factory implements GunFactory {
   public Item createGun(CommonProxy commonProxy) {
      return (new Weapon.Builder()).withModId("mw").withName("M107").withFireRate(0.16F).withRecoil(4.0F).withZoom(0.9F).withMaxShots(new int[]{1}).withShootSound("M107").withSilencedShootSound("RifleSilencer").withReloadSound("AKReload").withUnloadSound("Unload").withReloadingTime(43L).withCrosshair("gun").withCrosshairRunning("Running").withCrosshairZoomed("Sight").withFlashIntensity(1.0F).withFlashScale(() -> {
         ...
         return Arrays.asList(new String[]{"Type: Anti-materiel sniper rifle", "Damage: 37.8", "Caliber: .50 BMG", "Magazines:", "10rnd .50 BMG Magazine (Type 2)", "Fire Rate: Semi"});
         ...
         if(model instanceof AKMiron1) {
            ...
            GL11.glScaled(0.2199999988079071D, 0.23000000417232513D, 0.2199999988079071D);
      ...
      }).withTextureNames(new String[]{"M107", "M107Blue", "M107Red", "Electric"}).withRenderer((new WeaponRenderer.Builder()).withModId("mw").withModel(new M107()).withEntityPositioning((itemStack) -> {
         ...
         GL11.glScaled(0.550000011920929D, 0.550000011920929D, 0.550000011920929D);
         GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
      }, 150L, 50L)}).withFirstPersonCustomPositioningUnloading(Magazines.M107BMag, new Transition[]{new Transition((renderContext) -> {
      ...
      }, 250L, 1000L)}).withFirstPersonCustomPositioningReloading(Magazines.M107BMag, new Transition[]{new Transition((renderContext) -> {
