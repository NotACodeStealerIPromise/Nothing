...
public class MP5A5Factory implements GunFactory {
   public Item createGun(CommonProxy commonProxy) {
      return (new Weapon.Builder()).withModId("mw").withName("HKMP5A5").withFireRate(0.75F).withRecoil(2.3F).withZoom(0.9F).withMaxShots(new int[]{Integer.MAX_VALUE, 1}).withShootSound("MP5").withSilencedShootSound("MP5Silenced").withReloadSound("StandardReload").withUnloadSound("Unload").withReloadingTime(43L).withCrosshair("gun").withCrosshairRunning("Running").withCrosshairZoomed("Sight").withFlashIntensity(1.0F).withFlashScale(() -> {
         ...
         return Arrays.asList(new String[]{"Type: Submachine gun", "Damage: 6.85", "Caliber: 9mm", "Magazines:", "25rnd 9mm Magazine", "Fire Rate: Auto"});
      ...
      }).withTextureNames(new String[]{"MP5A5", "Electric"}).withRenderer((new WeaponRenderer.Builder()).withModId("mw").withModel(new MP5A5()).withEntityPositioning((itemStack) -> {
