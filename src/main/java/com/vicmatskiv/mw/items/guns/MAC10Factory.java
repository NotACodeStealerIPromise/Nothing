...
public class MAC10Factory implements GunFactory {
   public Item createGun(CommonProxy commonProxy) {
      ...
      }).withInaccuracy(2.0F).withCreativeTab(ModernWarfareMod.PistolsTab).withCrafting(CraftingComplexity.MEDIUM, new Object[]{CommonProxy.SteelPlate, CommonProxy.MiniSteelPlate}).withInformationProvider((stack) -> {
         return Arrays.asList(new String[]{"Type: Machine pistol", "Damage: 5.5", "Caliber: .45 ACP", "Magazines:", "26rnd .45 ACP Magazine", "Fire Rate: Auto"});
