...
public class M14Factory implements GunFactory {
   public Item createGun(CommonProxy commonProxy) {
      return (new Weapon.Builder()).withModId("mw").withName("M14").withFireRate(0.4F).withRecoil(2.0F).withZoom(0.9F).withMaxShots(new int[]{1, Integer.MAX_VALUE}).withShootSound("M14").withSilencedShootSound("RifleSilencer").withReloadSound("m14reload").withUnloadSound("Unload").withReloadingTime(45L).withCrosshair("gun").withCrosshairRunning("Running").withCrosshairZoomed("Sight").withFlashIntensity(1.0F).withFlashScale(() -> {
         ...
         return Arrays.asList(new String[]{"Type: Designated marksmen rifle", "Damage: 14", "Caliber: 7.62x51mm NATO", "Magazines:", "21rnd 7.62x51mm NATO Magazine", "Fire Rate: Semi"});
      ...
      }).withTextureNames(new String[]{"M14DMR"}).withRenderer((new WeaponRenderer.Builder()).withModId("mw").withModel(new M14DMR()).withEntityPositioning((itemStack) -> {
