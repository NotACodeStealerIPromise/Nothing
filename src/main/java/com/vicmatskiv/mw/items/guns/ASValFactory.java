...
public class ASValFactory implements GunFactory {
   public Item createGun(CommonProxy commonProxy) {
      return (new Weapon.Builder()).withModId("mw").withName("ASVal").withFireRate(0.5F).withRecoil(2.8F).withZoom(0.9F).withMaxShots(new int[]{Integer.MAX_VALUE, 1}).withShootSound("VSSVintorez").withReloadSound("vssvintorezreload").withUnloadSound("akunload").withReloadingTime(45L).withCrosshair("gun").withCrosshairRunning("Running").withCrosshairZoomed("Sight").withFlashIntensity(1.0F).withFlashScale(() -> {
         return Float.valueOf(0.0F);
      }).withFlashOffsetX(() -> {
         return Float.valueOf(0.1F);
      }).withFlashOffsetY(() -> {
         return Float.valueOf(0.1F);
      }).withInaccuracy(2.0F).withCrafting(CraftingComplexity.MEDIUM, new Object[]{CommonProxy.SteelPlate, CommonProxy.MiniSteelPlate, CommonProxy.MetalComponents, "ingotSteel"}).withCreativeTab(ModernWarfareMod.SnipersTab).withInformationProvider((stack) -> {
         return Arrays.asList(new String[]{"Type: Suppressed Assault Rifle", "Damage: 10", "Caliber: 9x39mm", "Magazines:", "10rnd 9x39mm Magazine", "20rnd 9x39mm Magazine", "Fire Rate: Auto"});
      ...
      }).withTextureNames(new String[]{"ASVal"}).withRenderer((new WeaponRenderer.Builder()).withModId("mw").withModel(new ASVal()).withEntityPositioning((itemStack) -> {
         ...
         GL11.glTranslatef(0.0F, 0.0F, 0.0F);
      }).withFirstPersonCustomPositioning(AuxiliaryAttachments.VSSVintorezAction.getRenderablePart(), (renderContext) -> {
         ...
         GL11.glRotatef(-10.0F, 0.0F, 0.0F, 1.0F);
         GL11.glTranslatef(-0.425F, 0.075F, 0.075F);
      }, 150L, 50L)}).withFirstPersonCustomPositioningUnloading(Magazines.VSSVintorezMag, new Transition[]{new Transition((renderContext) -> {
      }, 250L, 1000L), new Transition((renderContext) -> {
         GL11.glTranslatef(0.0F, 1.5F, 0.0F);
      }, 250L, 1000L)}).withFirstPersonCustomPositioningReloading(Magazines.VSSVintorezMag, new Transition[]{new Transition((renderContext) -> {
         GL11.glTranslatef(0.0F, 1.5F, 0.0F);
      }, 250L, 1000L), new Transition((renderContext) -> {
      }, 250L, 1000L), new Transition((renderContext) -> {
      }, 250L, 1000L), new Transition((renderContext) -> {
      }, 250L, 1000L), new Transition((renderContext) -> {
      }, 250L, 1000L)}).withFirstPersonCustomPositioningUnloading(Magazines.ASValMag, new Transition[]{new Transition((renderContext) -> {
      }, 250L, 1000L), new Transition((renderContext) -> {
         GL11.glTranslatef(0.0F, 1.5F, 0.0F);
      }, 250L, 1000L)}).withFirstPersonCustomPositioningReloading(Magazines.ASValMag, new Transition[]{new Transition((renderContext) -> {
         GL11.glTranslatef(0.0F, 1.5F, 0.0F);
      }, 250L, 1000L), new Transition((renderContext) -> {
      }, 250L, 1000L), new Transition((renderContext) -> {
      }, 250L, 1000L), new Transition((renderContext) -> {
      }, 250L, 1000L), new Transition((renderContext) -> {
      }, 250L, 1000L)}).withFirstPersonCustomPositioningUnloading(AuxiliaryAttachments.VSSVintorezAction.getRenderablePart(), new Transition[]{new Transition((renderContext) -> {
      }, 500L, 1000L), new Transition((renderContext) -> {
      }, 500L, 1000L)}).withFirstPersonCustomPositioningReloading(AuxiliaryAttachments.VSSVintorezAction.getRenderablePart(), new Transition[]{new Transition((renderContext) -> {
      }, 250L, 1000L), new Transition((renderContext) -> {
      }, 250L, 1000L), new Transition((renderContext) -> {
      }, 250L, 1000L), new Transition((renderContext) -> {
         GL11.glTranslatef(0.0F, 0.0F, 1.0F);
