...
public class ScarHFactory implements GunFactory {
   public Item createGun(CommonProxy commonProxy) {
      return (new Weapon.Builder()).withModId("mw").withName("ScarH").withFireRate(0.7F).withRecoil(3.6F).withZoom(0.9F).withMaxShots(new int[]{Integer.MAX_VALUE, 3, 1}).withShootSound("ScarH").withSilencedShootSound("AR15Silenced").withReloadSound("StandardReload").withUnloadSound("Unload").withReloadingTime(50L).withCrosshair("gun").withCrosshairRunning("Running").withCrosshairZoomed("Sight").withFlashIntensity(1.0F).withFlashScale(() -> {
         ...
         return Arrays.asList(new String[]{"Type: Battle rifle", "Damage: 7.4", "Nickname: Scar-H", "Caliber: .300 AAC Blackout", "Magazines:", "30rnd .300 AAC Blackout Magazine", "Fire Rate: Auto"});
         ...
         GL11.glScaled(1.0D, 1.0D, 1.0D);
      }).withTextureNames(new String[]{"ScarH"}).withRenderer((new WeaponRenderer.Builder()).withModId("mw").withModel(new Scar()).withEntityPositioning((itemStack) -> {
         ...
         GL11.glRotatef(-15.0F, 0.0F, 0.0F, 1.0F);
         GL11.glTranslatef(-0.275F, 0.2F, -0.1F);
      }, 200L, 50L)}).withFirstPersonCustomPositioningUnloading(Magazines.ScarHMag, new Transition[]{new Transition((renderContext) -> {
      ...
      }, 250L, 1000L)}).withFirstPersonCustomPositioningReloading(Magazines.ScarHMag, new Transition[]{new Transition((renderContext) -> {
         GL11.glTranslatef(0.3F, 1.7F, 0.1F);
         GL11.glRotatef(-30.0F, 0.0F, 0.0F, 1.0F);
      }, 250L, 1000L), new Transition((renderContext) -> {
         GL11.glTranslatef(-0.01F, 0.0F, 0.0F);
