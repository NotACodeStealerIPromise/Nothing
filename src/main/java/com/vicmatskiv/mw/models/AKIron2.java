...
public class AKIron2 extends ModelBase {
   ...
   public AKIron2() {
      ...
      this.sight1.addBox(0.0F, 0.0F, 0.0F, 1, 8, 1);
      this.sight1.setRotationPoint(0.0F, -5.0F, 0.0F);
      ...
      this.sight3.addBox(0.0F, 0.0F, 0.0F, 1, 8, 1);
      ...
      this.sight5.addBox(0.0F, 0.0F, 0.0F, 1, 5, 1);
      this.sight5.setRotationPoint(0.0F, -5.0F, 1.0F);
      ...
      this.sight6.addBox(0.0F, 0.0F, 0.0F, 1, 5, 1);
      this.sight6.setRotationPoint(-3.0F, -5.0F, 1.0F);
      ...
      this.sight7.addBox(0.0F, 0.0F, 0.0F, 1, 1, 8);
      this.sight7.setRotationPoint(0.0F, -5.0F, 2.0F);
      this.sight7.setTextureSize(64, 32);
      this.sight7.mirror = true;
      this.setRotation(this.sight7, -1.152537F, 0.0F, 0.0F);
      this.sight8 = new ModelRenderer(this, 0, 0);
      this.sight8.addBox(0.0F, 0.0F, 0.0F, 1, 1, 8);
      this.sight8.setRotationPoint(-3.0F, -5.0F, 2.0F);
      this.sight8.setTextureSize(64, 32);
      this.sight8.mirror = true;
      this.setRotation(this.sight8, -1.152537F, 0.0F, 0.0F);
      this.sight9 = new ModelRenderer(this, 0, 0);
      this.sight9.addBox(0.0F, 0.0F, 0.0F, 1, 2, 5);
      this.sight9.setRotationPoint(0.0F, 2.0F, 0.2F);
      ...
      this.sight10.addBox(0.0F, 0.0F, 0.0F, 1, 2, 5);
      this.sight10.setRotationPoint(-3.0F, 2.0F, 0.2F);
      ...
      this.sight11.addBox(0.0F, 0.0F, 0.0F, 1, 3, 1);
      this.sight11.setRotationPoint(-3.0F, -3.0F, 1.9F);
      ...
      this.sight12.addBox(0.0F, 0.0F, 0.0F, 1, 3, 1);
      this.sight12.setRotationPoint(0.0F, -3.0F, 1.9F);
      ...
      this.sight13.setRotationPoint(0.0F, -1.0F, 2.8F);
      ...
      this.sight14.setRotationPoint(-3.0F, -1.0F, 2.8F);
